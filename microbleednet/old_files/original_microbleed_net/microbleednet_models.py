...
from microbleednet.old_files.utils import model_utils
import numpy as np
import torch
...
class CDetNet(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, init_channels, bilinear=False):
        ...
        self.up2 = model_utils.Up(init_channels*4, init_channels*2, 3, name="up2_", bilinear=bilinear)
        self.up1 = model_utils.Up(init_channels*2, init_channels, 3, name="up1_", bilinear=bilinear)
...
class CDiscStudentNet(nn.Module):
    def __init__(self, n_channels, n_classes, init_channels, bilinear=False):
        ...
        self.classconvfirst = model_utils.SingleConv(init_channels * 4, init_channels * 2, 1, name="clconvfirst_")
        self.classdown1 = model_utils.Down(init_channels * 2, init_channels * 2, 3, 3, name="down1_")
        self.classdown2 = model_utils.Down(init_channels * 2, init_channels * 2, 3, 3, name="down2_")
