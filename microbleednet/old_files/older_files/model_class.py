...
class MedClassNet24(nn.Module):
    def __init__(self, n_channels, n_classes, batch_size, init_channels, bilinear=False):
        super(MedClassNet24, self).__init__()
        self.batch_size = batch_size
        self.n_channels = n_channels
        self.init_channels = init_channels
        self.n_classes = n_classes
        ...
        self.convfirst = SingleConv(init_channels, init_channels//2, 1)
        self.down1 = Down(init_channels//2, init_channels//2, 3, 3)
        self.down2 = Down(init_channels//2, init_channels//2, 3, 3)
...
class MedClassNet32(nn.Module):
    def __init__(self, n_channels, n_classes, batch_size, init_channels, bilinear=False):
        super(MedClassNet32, self).__init__()
        self.batch_size = batch_size
        self.n_channels = n_channels
        self.init_channels = init_channels
        self.n_classes = n_classes
        ...
        self.convfirst = SingleConv(init_channels, init_channels//2, 1)
        self.down1 = Down(init_channels, init_channels, 3, 3)
        self.down2 = Down(init_channels, init_channels, 3, 3)
        #self.down3 = Down(init_channels, init_channels//2, 1)
...
class MedClassNet48(nn.Module):
    def __init__(self, n_channels, n_classes, batch_size, init_channels, bilinear=False):
        super(MedClassNet48, self).__init__()
        self.batch_size = batch_size
        self.n_channels = n_channels
        self.init_channels = init_channels
        self.n_classes = n_classes
        ...
        self.down1 = Down(init_channels, init_channels, 3, 3)
        self.down2 = Down(init_channels, init_channels, 3, 3)
        self.down3 = Down(init_channels, init_channels, 3, 1)
        self.fc1 = nn.Linear(512, 128)
        self.fc2 = nn.Linear(128, 32)
        self.fc3 = nn.Linear(32,2)
