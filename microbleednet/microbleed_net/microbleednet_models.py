...
class CDiscNet24(nn.Module):
    """
        Microbleednet Candidate Discrimination Model definition
    """
    def __init__(self, n_channels, n_classes, init_channels, bilinear=False):
        super(CDiscNet24, self).__init__()
        self.n_channels = n_channels
        self.init_channels = init_channels
        self.n_classes = n_classes
        self.n_layers = 3
...
class CDiscNet32(nn.Module):
    def __init__(self, n_channels, n_classes, init_channels, bilinear=False):
        super(CDiscNet32, self).__init__()
        self.n_channels = n_channels
        self.init_channels = init_channels
        self.n_classes = n_classes
        self.n_layers = 3
...
class CDiscNet48(nn.Module):
    def __init__(self, n_channels, n_classes, init_channels, bilinear=False):
        super(CDiscNet48, self).__init__()
        self.n_channels = n_channels
        self.init_channels = init_channels
        self.n_classes = n_classes
        self.n_layers = 3
